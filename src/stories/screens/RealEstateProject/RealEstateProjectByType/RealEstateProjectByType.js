...
class RealEstateProjectByType extends Component {
    constructor(props) {
        super(props);
        this.state = {
            propertyList: [],
    ...
    renderItem = ({ item, index }) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => parent.props.navigation.navigate('RealEstateProjectDetail', { propertyId: item.id, propertyTitle: item.title })}
...
export default RealEstateProjectByType;
